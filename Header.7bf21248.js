...
})({"26CGp":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "2b5a7d267bf21248";
"use strict";
...
},{}],"3PJ6N":[function(require,module,exports,__globalThis) {
...
const Header = ()=>{
    _s();
    const [btnToggle, setBtnToggle] = (0, _react.useState)(true);
    const onlineStatus = (0, _useOnlineStatusDefault.default)();
    const { loggedInUser } = (0, _react.useContext)((0, _userContextDefault.default));
    const itemsArray = (0, _reactRedux.useSelector)((store)=>store.cart.items);
    // console.log("header",itemsArray);
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "flex sm:bg-blue-100 md:bg-green-100 lg:bg-pink-100  justify-between  shadow-lg px-2 sticky top-0 z-10",
        children: [
                ...
                children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("ul", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            ...
                            children: btnToggle ? "Login" : "Logout"
                        }, void 0, false, {
                            fileName: "src/components/Header.js",
                            lineNumber: 43,
                            columnNumber: 11
...
_s(Header, "TtgWDmcqekkY//Z7zkgkDewwF6I=", false, function() {
    return [
