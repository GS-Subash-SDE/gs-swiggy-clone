...
var _s = $RefreshSig$();
let col;
let dummy = (0, _mockDataDefault.default)?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants;
const Body = ()=>{
    _s();
    // console.log(dummy);
    const [tempList, setTempList] = (0, _react.useState)((0, _mockDataDefault.default).length === 0 ? null : dummy);
    const [filteredList, setFilteredList] = (0, _react.useState)((0, _mockDataDefault.default).length === 0 ? null : dummy);
    const [searchVal, setSearchVal] = (0, _react.useState)("");
    const onlineStatus = (0, _useOnlineStatusDefault.default)();
    const { loggedInUser, setGlobalText } = (0, _react.useContext)((0, _userContextDefault.default));
    (0, _react.useEffect)(()=>{
        // Function Logic Here.
        getData();
    ...
    const getData = async ()=>{
        try {
            ...
            navigator.geolocation.getCurrentPosition(async (position)=>{
                ...
                // console.log(lat, lng);
                const res = await fetch(`${(0, _mockData.corsproxies)}https://www.swiggy.com/mapi/restaurants/list/v5?offset=0&is-seo-homepage-enabled=true&lat=${lat}&lng=${lng}&carousel=true&third_party_vendor=1`);
    ...
    // };
    const handleSearch = ()=>{
        let temp = tempList.filter((a)=>a?.info?.name?.toLowerCase().includes(searchVal?.toLowerCase()));
    ...
    if (tempList === null) return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _shimmerCardDefault.default), {}, void 0, false, {
        fileName: "src/components/Body.js",
        lineNumber: 142,
        columnNumber: 12
    }, undefined);
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                        ...
                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                            className: "filterBtn bg-gray-100 px-4 py-1 rounded-lg active:scale-92 hover:bg-gray-200 hover:cursor-pointer",
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                className: "resContainer flex flex-wrap",
                children: filteredList?.map((cards)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _reactRouterDom.Link), {
                        to: `restaurants/${cards?.info.id}`,
                        children: cards?.info?.veg ? /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _restaurantCard.WithVegTag), {
                            resList: cards?.info
                        }, void 0, false, {
                            fileName: "src/components/Body.js",
                            lineNumber: 188,
...
_s(Body, "3+60VsL6BOD8onMy9vSIFcnHVQo=", false, function() {
    return [
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WithVegTag", ()=>WithVegTag);
var _jsxDevRuntime = require("react/jsx-dev-runtime");
var _react = require("react");
...
const RestaurantCard = (props)=>{
    ...
    const { resList } = props;
    // console.log(resList);
    const { id, name, cloudinaryImageId: imageUrl, locality, avgRating: rating_text, costForTwo, sla: { slaString } } = resList;
    ...
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        className: "resCard p-2 m-2  w-[200px] aspect-6/9 bg-gray-100 rounded-lg hover:shadow-lg hover:bg-gray-200",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("img", {
                className: "resLogo rounded-lg aspect-3/2",
                src: (0, _constants.PRE_IMG_URL) + imageUrl,
                alt: "resCard-img"
            }, void 0, false, {
...
_c = RestaurantCard;
const WithVegTag = (props)=>{
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        className: "relative",
        children: [
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("span", {
                className: "text-white bg-green-500 absolute top-0 w-10  rounded-sm  font-bold inline-block px-2 ",
                children: "Veg"
            }, void 0, false, {
                fileName: "src/components/RestaurantCard.js",
                lineNumber: 51,
...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","../../utils/constants":"jcEU6","../../utils/UserContext":"79uRI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi"}],"jcEU6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "LOGO_URL", ()=>LOGO_URL);
parcelHelpers.export(exports, "PRE_IMG_URL", ()=>PRE_IMG_URL);
const LOGO_URL = "https://img.pikbest.com/png-images/20241016/beautiful-and-unique-logo-design-for-food-restaurant-company_10966666.png!w700wp";
const PRE_IMG_URL = "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_366/";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aFz4T":[function(require,module,exports,__globalThis) {
var $parcel$ReactRefreshHelpers$de12 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
$parcel$ReactRefreshHelpers$de12.init();
var prevRefreshReg = globalThis.$RefreshReg$;
var prevRefreshSig = globalThis.$RefreshSig$;
$parcel$ReactRefreshHelpers$de12.prelude(module);
...
exports.default = useOnlineStatus;
  ...
  $parcel$ReactRefreshHelpers$de12.postlude(module);
} finally {
  globalThis.$RefreshReg$ = prevRefreshReg;
  globalThis.$RefreshSig$ = prevRefreshSig;
}
